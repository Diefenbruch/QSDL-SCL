...
+---------------+-------------------+---------------+-------------------+-------+
| SCMachineFCFS | SCMachineFCFS.h   | 13. Jul 1994  |   SCL             |       |
+---------------+-------------------+---------------+-------------------+-------+
|                                                                               |
|   Change Log                                                                  |
|                                                                               |
...
#ifndef __SCMACHINEFCFS__

#define __SCMACHINEFCFS__


#include "SCMachineLtd.h"

class SCMachineFCFS : public SCMachineLtd
{
  public:
                       SCMachineFCFS (SCRunnableID pMachineID,
                                      SCNatural pServers,
                                      SCNatural pServices,
                                      const SCDuration *const pSpeeds,
                                      const char *pName,
                                      SCObject *father = NULL);
    virtual           ~SCMachineFCFS (void);
