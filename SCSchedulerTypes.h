...
+---------------+-------------------+---------------+-------------------+-------+
|               | SCSchedulerTypes.h | 4. Jun 1996   |   SCL             |       |
+---------------+-------------------+---------------+-------------------+-------+
|                                                                               |
|   Change Log                                                                  |
|                                                                               |
...
#ifndef __SCSCHEDULERTYPES__

#define __SCSCHEDULERTYPES__
...
#define SCMacintoshThreads   2
    ...
    #include "SCPosixSystemScheduler.h"
  #endif  //  SCPosixThreads

  #if (_SC_THREAD_TYPE == SCMacintoshThreads)
    #include "SCMacSystemScheduler.h"
